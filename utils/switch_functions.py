...
def model_class_pointer(task_name, model_name):
    ...
    if task_name == "shape_corr":
        ...
        elif model_name == 'LuckPointCorr_mae':
            from models.DeepPointCorr.LuckPointCorr_mae import LuckPointCorr
            return LuckPointCorr
        elif model_name == 'LuckPointCorr_fps':
            from models.DeepPointCorr.LuckPointCorr_fps import LuckPointCorr
            return LuckPointCorr
        elif model_name == 'LuckPointCorr_fps_mae':
            from models.DeepPointCorr.LuckPointCorr_fps_mae import LuckPointCorr
            return LuckPointCorr
        elif model_name == 'LuckPointCorr_fps_mae_v2':
            from models.DeepPointCorr.LuckPointCorr_fps_mae_v2 import LuckPointCorr
            return LuckPointCorr
        elif model_name == 'LuckPointCorr_select_mae':
            from models.DeepPointCorr.LuckPointCorr_select_mae import LuckPointCorr
            return LuckPointCorr
        ...
        elif model_name == 'ImplicitTemplatePointCorr':
            from models.DeepPointCorr.ImplicitTemplatePointCorr import ImplicitTemplatePointCorr
            return ImplicitTemplatePointCorr
    else:        
